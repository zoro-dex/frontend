        ...
        <div className='w-full max-w-xs sm:max-w-sm space-y-4 sm:space-y-4'>
          ...
          <div className='flex justify-center -my-1'>
            <Button
                variant='outline'
                size='icon'
                className='h-8 w-8 sm:h-10 sm:w-10 border border-primary/20 bg-primary/10 text-primary hover:bg-primary/20 hover:border-primary/30'
                onClick={swapPairs}
                disabled={isLoadingSwap}
            >
              <svg width="57" height="57" viewBox="0 0 57 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="0.000152588" width="56.3444" height="56.3444" fill="#F9F9F9"/>
