...
export function SwapSettings({ slippage, onSlippageChange }: SwapSettingsProps) {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event: MouseEvent): void => {
      ...
      // Check if click is outside both the trigger button and the settings panel
  ...
  return (
    <div className='relative'>
      <Button
        data-settings-trigger // Data attribute for click-outside detection
        variant='ghost'
        size='icon'
        onClick={handleToggle}
        className={`transition-all duration-200 hover:bg-accent hover:text-accent-foreground relative z-10 ${
      ...
      {isOpen && (
        <Card 
          data-settings-panel // Data attribute for click-outside detection
          className='absolute top-12 right-0 w-[200px] sm:w-[220px] z-50 border shadow-xl bg-popover'
        >
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <div className='group relative'>
                  ...
                  {/* Tooltip */}
                  <div className='absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block z-[60]'>
